...
describe('calculateTrendFromScores', () => {
  ...
  test('returns stable trend for empty scores', () => {
    const result = calculateTrendFromScores([], '7d');
  ...
  test('calculates upward trend correctly', () => {
    ...
    const result = calculateTrendFromScores(scores, '7d');
  ...
  test('filters scores by period correctly', () => {
    ...
    const result = calculateTrendFromScores(scores, '30d');
...
describe('detectAlerts', () => {
  ...
  test('detects high severity score drop', () => {
    const alerts = detectAlerts(7.5, 8.1, [], 1);
  ...
  test('detects medium severity score drop', () => {
    const alerts = detectAlerts(7.7, 8.1, [], 1);
  ...
  test('detects score rise', () => {
    const alerts = detectAlerts(8.6, 8.0, [], 1);
  ...
  test('does not alert for stable scores', () => {
    const alerts = detectAlerts(8.0, 8.05, [], 1);
    
    const scoreAlerts = alerts.filter(a => 
      a.type === 'score_drop' || a.type === 'score_rise'
    );
  ...
  test('detects review spike', () => {
    ...
    const alerts = detectAlerts(8.0, null, reviews, 1); // Normal rate: 1/day
  ...
  test('detects negative review', () => {
    ...
    const alerts = detectAlerts(8.0, null, reviews, 1);
...
describe('calculateSentiment', () => {
  ...
  test('categorizes ratings correctly', () => {
    ...
    const result = calculateSentiment(reviews);
...
describe('calculateMarketPosition', () => {
  test('handles no competitors', () => {
    const result = calculateMarketPosition(8.0, []);
  ...
  test('calculates rank correctly - top position', () => {
    const result = calculateMarketPosition(9.0, [8.0, 7.0, 6.0]);
    expect(result.rank).toBe(1);
  ...
  test('calculates rank correctly - middle position', () => {
    const result = calculateMarketPosition(7.5, [9.0, 8.0, 7.0, 6.0]);
    expect(result.rank).toBe(3);
    expect(result.totalCompetitors).toBe(4);
  });

  test('calculates rank correctly - bottom position', () => {
    const result = calculateMarketPosition(5.0, [9.0, 8.0, 7.0]);
  ...
  test('calculates market average correctly', () => {
    const result = calculateMarketPosition(8.0, [8.0, 8.0, 8.0]);
...
describe('generateTimelineData', () => {
  ...
  test('returns empty array for no scores', () => {
    const result = generateTimelineData([], '7d');
  ...
  test('formats dates correctly', () => {
    ...
    const result = generateTimelineData(scores, '7d');
  ...
  test('filters by period', () => {
    ...
    const result = generateTimelineData(scores, '30d');
    expect(result).toHaveLength(2);
  });
...
describe('calculateReviewRate', () => {
  ...
  test('returns 0 for no reviews', () => {
    const result = calculateReviewRate([], 30);
  ...
  test('calculates rate correctly', () => {
    ...
    const result = calculateReviewRate(reviews, 30);
...
describe('ALERT_THRESHOLDS', () => {
  test('thresholds are correctly defined', () => {
    expect(ALERT_THRESHOLDS.SCORE_DROP_MEDIUM).toBe(-0.3);
    expect(ALERT_THRESHOLDS.SCORE_DROP_HIGH).toBe(-0.5);
    expect(ALERT_THRESHOLDS.SCORE_RISE_MEDIUM).toBe(0.3);
    expect(ALERT_THRESHOLDS.SCORE_RISE_HIGH).toBe(0.5);
    expect(ALERT_THRESHOLDS.REVIEW_SPIKE_FACTOR).toBe(2);
    expect(ALERT_THRESHOLDS.NEGATIVE_REVIEW_RATING).toBe(2);
  });
});
